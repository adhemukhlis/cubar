...
export const firebaseRefPlayerOnRoom = (roomcode, uid) => firebaseRefRoom(roomcode).child('player').child(uid)
export const firebaseRefPlayers = (roomcode) => firebaseRefRoom(roomcode).child('player')
